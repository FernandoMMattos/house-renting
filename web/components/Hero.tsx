...
const Hero = () => {
  ...
  const handleSearch = (codes: number[]) => {
  ...
  return (
    <section
      className="w-full flex flex-col align-middle items-center text-center p-10 gap-10 bg-no-repeat bg-cover bg-center pb-40 text-white"
      style={{ backgroundImage: `url(${HeroBanner.src})` }}
    >
      <Header />
      <label htmlFor="search" className="text-5xl font-bold">
